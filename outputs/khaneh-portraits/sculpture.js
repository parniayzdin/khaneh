...
(() => {
  ...
  window.openHamidSculpture = (person, source) => {
    ...
    dialog.querySelector('.sculpture-caption').innerHTML='<strong>THE STORY BEHIND THE POSE</strong>'+(isNika?'An artistic tribute inspired by the supplied photograph, with a newly imagined peace-sign gesture. The face is deliberately simplified; this is not a reconstruction of a documented moment.':isKhodanoor?'This seated pose recalls a photograph of Khodanoor during his detention in Zahedan in July 2022. He was bound to a pole, with a cup of water placed beyond his reach.':'The carrying pose honors accounts of Hamid helping wounded protesters during the January 2026 protests. Iran International reports that witnesses described him carrying injured people away from security forces. The identity of the rescuer in the widely shared footage has not been confirmed with certainty; this sculpture pays tribute to those accounts of care and courage.');
